...
BUTTON_PIN = 18 # Utilisation de GPIO 18 (D18) comme demandé
...
double_click_timeout = 400 # ms pour la détection du double clic (ajusté pour fiabilité)

# ==================== FONCTIONS DE GESTION ET CALCUL D'ANGLE ====================
...
def handle_button_press(servo_pwm):
    ...
    if button.value() == 1 and last_button_press_time > 0:
        ...
        # 1. Détection du DOUBLE CLIC (Bonus 2)
        ...
        # 2. Détection du CLIC SIMPLE (Bonus 1)
